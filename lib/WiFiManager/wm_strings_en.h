...
"<form action='/param'   method='get'><button>安装</button></form><br/>\n",//MENU_PARAM
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>保存网络凭证。<br/>正在尝试连接到网络。<br />如果失败，请重新连接AP后再试</div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>连接</strong> 到 {v}<br/><em><small>IP为： {i}</small></em></div>";
